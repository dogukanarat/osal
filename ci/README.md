...
- Test executable: `build/test/test_libscaffold`
...
**Output:**
- Optimized library: `build/liblibscaffold.a`
...
- **User install** (`~/.local`):
  - Libraries: `~/.local/lib/`
  - Headers: `~/.local/include/libscaffold/`
  - CMake config: `~/.local/lib/cmake/libscaffold/`

- **Custom prefix** (`/opt/mylibs`):
  - Libraries: `/opt/mylibs/lib/`
  - Headers: `/opt/mylibs/include/libscaffold/`
  - CMake config: `/opt/mylibs/lib/cmake/libscaffold/`
...
- Check test assertions in `test/test_libscaffold.c`
