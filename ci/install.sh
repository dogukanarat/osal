...
print_info "  - Headers: $INSTALL_PREFIX/include/osal/"
print_info "  - CMake config: $INSTALL_PREFIX/lib/cmake/osal/"
echo ""
...
echo "  find_package(osal REQUIRED)"
echo "  target_link_libraries(your_target PRIVATE osal::osal)"
echo ""
